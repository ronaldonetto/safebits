...
O acesso às informações deve ser limitado apenas a usuários autorizados.

A aplicação do princípio do menor privilégio reduz significativamente os riscos de vazamento.
